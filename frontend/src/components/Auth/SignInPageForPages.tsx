...
/**
 * Sign-in page content for Pages Router (/auth/sign-in).
 * Avoids App Router entirely so "invariant expected layout router to be mounted" never runs.
 */
export default function SignInPageForPages() {
  return (
    <ThemeProvider
      defaultTheme="light"
      attribute="class"
